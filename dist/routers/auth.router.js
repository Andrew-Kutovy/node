...
router.post("/register", common_middleware_1.commonMiddleware.isBodyValid(user_validator_1.UserValidator.register), auth_controller_1.authController.register);
